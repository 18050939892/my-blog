import { c as createAstro, a as createComponent, m as maybeRenderHead, b as addAttribute, r as renderComponent, d as renderTemplate } from './astro/server_DzI7NwzY.mjs';
import 'kleur/colors';
import dayjs from 'dayjs';
import utc from 'dayjs/plugin/utc.js';
import timezone from 'dayjs/plugin/timezone.js';
import { c as createSvgComponent } from './Footer_C74O1_X4.mjs';
...
Updated:
</span>` : renderTemplate`<span${addAttribute(["text-sm italic", { "sm:text-base": size === "lg" }], "class:list")}>
Published:
</span>
      <!--<span class="sr-only">Published:</span>-->`} <span${addAttribute(["text-sm italic", { "sm:text-base": size === "lg" }], "class:list")}> <time${addAttribute(datetime.toISOString(), "datetime")}>${date}</time> <span aria-hidden="true"> | </span> <span class="sr-only">&nbsp;at&nbsp;</span> <span class="text-nowrap">${time}</span> </span> </div>`;
}, "D:/Users/LinZhiJie/Downloads/my-blog/src/components/Datetime.astro", void 0);
